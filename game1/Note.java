...
//게임을 하기 위해 모든 노트의 구성등을 관리 하는 클래스
public class Note extends Thread {
	...
	private boolean process = true; /*현재 노트의 진행 여부 */
	Score score;
	String difficulty;
	...
	public boolean isProcessing() {   /*현재 진행되는 것에 대한 getter 함수*/
		return process;
	}

	public void close() {  /*노트를 타이밍에 성공적으로 입력했을때 노트들이 움직이지 않도록 하게함*/
		process = false;
	}
	...
	public void easydrop() {
		y += Main.EASY_SPEED;
		if (y > 620) {
			System.out.println("Miss");		/*miss에 대한 판정*/
			close();
		}
	}
